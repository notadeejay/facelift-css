...
- [Link to whole lesson figma design](https://www.figma.com/file/pMngsIjKrmCyVe8z4DCGFX/Lesson-Redesign-Components?node-id=551%3A288)
...
<div class="lesson-part__contentBlock">
  <div class="block html" name="block_98351726-b470-4c1e-9c09-6ace4c2167a7">
    <div class="section">
      <div class="html__title">
        <h2>This Block Includes Dropdowns</h2>
      </div>
      .....
    </div>
  </div>
...
- [Link to figma design](https://www.figma.com/file/pMngsIjKrmCyVe8z4DCGFX/Lesson-Redesign-Components?node-id=777%3A2)
...
<div class="answer-buttons">
  <div class="steps" aria-labelledby="question-progress">
    <button
      type="button"
      disabled=""
    ...
    <button type="button" class="steps__arrow right" aria-label="Next">
      <svg
        width="16"
        height="28"
        viewBox="0 0 16 28"
  ...
  <div class="answer-buttons__buttons">
    <button
      type="button"
      class="button-standard button-standard--green button-standard--short"
    >
      <span>Next</span>
    </button>
  </div>
...
<div class="knowledge-check__header">
  <h1 class="heading">Missing Values in the World Happiness Dataset</h1>
...
```html
<div class="lesson-part__contentBlock">
  <div class="block embed" name="block_23a892ff-1a0b-4fca-871c-a06a5bc217c1">
    <div class="section">
...
```html
<div class="block-label__content">
  <div style="width: 100%;">
    <iframe
      width="100%"
      height="500"
      ...
      allowfullscreen=""
      title="Salesforce Business Analyst Intro"
    ></iframe>
  </div>
  <h2 class="heading">How to Setup MySQL Workbench</h2>
</div>
```
...
<div class="block-header block-label__wrapper block-label__wrapper--static">
  <span
    ...
    ><svg width="22" height="12" viewBox="0 0 22 16">
      ...
      ></path></svg
  ></span>
  <span class="label"><span>Media</span></span>
</div>
```

### Lab Block

- [Link to figma design](https://www.figma.com/file/pMngsIjKrmCyVe8z4DCGFX/Lesson-Redesign-Components?node-id=1301%3A2)
...
<div class="block-header block-label__wrapper block-label__wrapper--static">
  ...
  ><span class="label"><span>Lab</span></span>
</div>
```
...
<div class="launch__wrapper">
  ...
  >
    ...
    <path
      d="M2 27.3694L2 1.5732L34 1.57321"
      stroke="#039BE8"
      stroke-width="3"
    />
    ...
    <path
      d="M213 63.6752L122 63.6752"
      stroke="#039BE8"
      stroke-width="3"
      stroke-dasharray="3 16"
    />
    <path
      d="M213 77.0509L122 77.0509"
      stroke="#039BE8"
      stroke-width="3"
      stroke-dasharray="3 16"
    />
    <path
      d="M213 90.4268L122 90.4268"
      stroke="#039BE8"
      stroke-width="3"
      stroke-dasharray="3 16"
    />
    <path
      d="M213 103.802L122 103.802"
      stroke="#039BE8"
      stroke-width="3"
      stroke-dasharray="3 16"
    />
    <path
      d="M213 117.178L122 117.178"
      stroke="#039BE8"
      stroke-width="3"
      stroke-dasharray="3 16"
    />
    ...
    />
    <path
      d="M64.4464 111.751C62.6056 111.242 61.0422 109.964 60.3208 108.15C59.0844 105.042 60.7906 101.539 64.1318 100.326C67.4729 99.1123 71.1838 100.649 72.4203 103.757C73.1694 105.64 72.8384 107.668 71.7182 109.244"
      stroke="white"
      stroke-width="1.5"
      stroke-linecap="round"
    />
    <path
      d="M74.3274 110.353C75.9134 108.002 76.3205 105.033 75.1442 102.33C73.2026 97.8665 67.6823 95.8155 62.8143 97.7487C57.9463 99.6818 55.574 104.867 57.5156 109.33C58.5598 111.73 60.639 113.433 63.0952 114.193"
      stroke="white"
      stroke-linecap="round"
    />
    <path
      d="M64.7528 132.296L64.8916 104.459L86.1571 123.264L78.6614 124.686L83.0424 134.162L76.2062 137.047L71.8253 127.57L64.7528 132.296Z"
      fill="#154268"
      stroke="#368FD5"
      stroke-width="1.5"
      stroke-linecap="round"
    ...
    <defs>
      ...
      >
        ...
        <feColorMatrix
          type="matrix"
          values="0 0 0 0 0.117647 0 0 0 0 0.333333 0 0 0 0 0.478431 0 0 0 0.15 0"
        />
        <feBlend
          mode="normal"
  ...
  <button type="button" class="launch"><span>Launch Lab</span></button>
</div>
```

- The lab block will likely take some tweaking, it has negative margins to expand across the full width of the page.
